              ...
              <div key={tab.id} className="panel compact-track">
                ...
                >
                  <span className="name">
                    {tab.emoji ? `${tab.emoji} ` : ""}
                    {tab.name}
                    {ownedHere ? <span className="pill" style={{ marginLeft: 6 }}>yours</span> : null}
                    {tab.activeDevice && !ownedHere ? (
                      <span className="pill" style={{ marginLeft: 6 }}>owned elsewhere</span>
                    ) : null}
                  </span>
                ...
                <div className="row wrap" style={{ marginTop: 8 }}>
                  <button className="btn" type="button" disabled={pending} onClick={() => resume(tab, true)}>
                    Resume
                  </button>
                  <button
